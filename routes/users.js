...
router.post("/login", async (req, res, next) => {
	try {
		...
		// Doesn't appear to find user in db
...
router.get("/test", async (req, res, next) => {
	return res.json({ message: "You've hit the test route" });
});

router.post("/test", async (req, res, next) => {
	const foundUser = req.body.username;

	const verifiedPw = req.body.password;
	console.log(req.body, verifiedPw);
